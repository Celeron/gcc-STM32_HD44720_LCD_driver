...
// Максимальное разрешение дисплея, поддерживаемое драйвером  
//  (Замечу: по факту, в железе есть еще ограничение на объем видеопамяти = 80 символов на пару строк. 
//  Поэтому, максимум дисплеи бывают 20x4 или 40x2 - т.е. бывают 24x2, но нет 24x4.)
#define HD44780_COLUMNS_AMOUNT_MAX  40
#define HD44780_LINES_AMOUNT_MAX    4
