...
Реализация передачи данных: программная, с блокирующей задержкой! Таким образом, загрузка данных довольно тормознутая (LCD1602: до 20мс на один Refresh дисплея, по 4-битной шине...)
